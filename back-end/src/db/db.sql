...
CREATE TABLE `orders` (
  ...
  `emittedTo` varchar(255) NOT NULL,
...
INSERT INTO `orders` (`id`, `orderNfId`, `orderNumber`, `orderPath`, `orderFileName`, `orderOriginalName`, `emissionDate`, `pdfFile`, `emittedTo`, `nNf`, `CTE`, `value`, `createdAt`, `updatedAt`, `cnpjId`, `userId`, `buyerId`, `providerId`, `orderStatusBuyer`, `orderStatusProvider`, `deliveryReceipt`, `cargoPackingList`, `deliveryCtrc`) VALUES
